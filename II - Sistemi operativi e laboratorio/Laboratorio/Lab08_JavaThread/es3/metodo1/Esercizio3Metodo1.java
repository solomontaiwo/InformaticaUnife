...
public class Esercizio3Metodo1 {
    ...
    public static void main(String args[]) {
        ...
        // WorkerThreadMetodo1 implementa l'interfaccia Runnable
        WorkerThreadMetodo1 wt[] = new WorkerThreadMetodo1[n];
        boolean running[] = new boolean[n];

        for(int i = 0; i < n; i++) {
            wt[i] = new WorkerThreadMetodo1(i);
