...
Lab10-2010-03-31-riordina-foto-ric.sh "$1"

echo La directory contenente il maggior numero di errori di compilazione è \
`cat $MAX_DIR` con `cat $MAX_ERRORS` errori totali.
