...
public class Client {
    public static void main(String args[]) {
        ...
        try {
            ...
            BufferedReader networkIn = new BufferedReader(new InputStreamReader(sock.getInputStream(), "UTF-8"));
            BufferedWriter networkOut = new BufferedWriter(new OutputStreamWriter(sock.getOutputStream(), "UTF-8"));
