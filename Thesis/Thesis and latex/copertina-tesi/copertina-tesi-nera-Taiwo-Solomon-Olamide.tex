...
\usepackage{lmodern} % Usare il pacchetto Latin Modern per una migliore qualità dei font
\usepackage{microtype} % Migliora qualità tipografica
...
{\flushright \color{pureblack}{\Large Capitolo \thechapter}}
{0.2ex}
{
    \rule{\textwidth}{3pt}
    \centering
